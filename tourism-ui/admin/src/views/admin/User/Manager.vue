  ...
  <div class="app-container">
    ...
    <div class="table-container">
      ...
      >
        ...
        <el-table-column label="真实姓名" align="center" width="110">
        ...
        <el-table-column label="联系电话" align="center" width="115">
...
export default {
  ...
  methods: {
    ...
    //6.新增
    userAdd() {
      this.$router.push({ name: "AddRegister", path: "addRegister" });

      // this.$router.push({ name: "AddUser", path: "addUser" });
    },
    //7.删除
    delete01(row) {
